...
const REGIONEN = [
    { value: 'Teutoburger Wald', label: 'Teutoburger Wald', color: '#2d5a27' },
    { value: 'Schwarzwald',      label: 'Schwarzwald',      color: '#1a3d2e' },
    { value: 'Eifel',            label: 'Eifel',            color: '#2c4a6e' },
    { value: 'Harz',             label: 'Harz',             color: '#4a4a6e' },
    { value: 'Sauerland',        label: 'Sauerland',        color: '#2e5c4a' },
    { value: 'Rheinsteig',       label: 'Rheinsteig',       color: '#1e4a5c' },
];
